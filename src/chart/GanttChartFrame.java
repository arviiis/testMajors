...
public class GanttChartFrame extends JFrame{
	...
	public GanttChartFrame(String tabTitle, String chartTitle) {
		...
		JFreeChart chart = ChartFactory.createGanttChart(chartTitle, "Agent name", "Timeline", createDataset(),
			 true, true, true);
...
//		JFreeChartGanttChartExample chart = new JFreeChartGanttChartExample(chartTitle, "OH agent schedules");
//		chart.pack(); 
